    ...
    with torch.no_grad():
        ...
        if H.n_samples == None:
            ...
            if H.dataset == 'cifar10':
                ...
                raise ValueError(f'No default n_samples specified for dataset {H.dataset}. Please specify number of samples to calculate per step using --n_samples')
        ...
        if H.dataset == 'cifar10':
            ...
            # TODO: Maybe only compute stats for H.n_samples images from the dataset?
